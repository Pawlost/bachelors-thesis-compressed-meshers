...
class ARMCVoxelModelActor;

UCLASS(Abstract)
class VOXELMODELGENERATION_API AAreaChunkSpawnerBase : public AChunkSpawnerBase
{
	GENERATED_BODY()
...
protected:
	...
	TQueue<TWeakObjectPtr<ARMCVoxelModelActor>, EQueueMode::Mpsc> UnusedActors;
