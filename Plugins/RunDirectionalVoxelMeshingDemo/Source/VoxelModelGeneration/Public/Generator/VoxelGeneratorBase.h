...
class VOXELMODELGENERATION_API UVoxelGeneratorBase : public UActorComponent
{
	GENERATED_BODY()
...
public:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(AllowAbstract="false", BlueprintBaseOnly), NoClear,
		Category="Voxels")
	TSubclassOf<UVoxelMesherBase> MesherBlueprint = nullptr;
...
protected:
	UPROPERTY()
	TObjectPtr<UVoxelMesherBase> Mesher;
