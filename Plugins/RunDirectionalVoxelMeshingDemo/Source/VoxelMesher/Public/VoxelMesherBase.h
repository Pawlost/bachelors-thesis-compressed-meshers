...
#include "MesherUtils/MeshingDirections.h"
...
class VOXELMESHER_API UVoxelMesherBase : public UActorComponent
{
	GENERATED_BODY()

public:
	void SetVoxelGenerator(const TObjectPtr<UVoxelGeneratorBase>& VoxelGeneratorBase);
	virtual void GenerateMesh(FMesherVariables& MesherVariables, FVoxelChange* VoxelChange) PURE_VIRTUAL(UVoxelMesherBase::GenerateMesh)
