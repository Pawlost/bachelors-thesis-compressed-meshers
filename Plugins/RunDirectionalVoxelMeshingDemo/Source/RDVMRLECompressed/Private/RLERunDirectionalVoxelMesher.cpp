...
#include "RLECompressedVoxel/RLEVoxel.h"
#include "RLECompressedVoxel/RLEVoxelGrid.h"
#include "Utils/VoxelChange.h"
                                          ...
                                          const FIntVector& InitialPosition, const FRLEVoxel& RLEVoxel, const int YEnd)
{
	...
	const FVoxelMergeFace NewFace = StaticData.FaceCreator(RLEVoxel.Voxel, InitialPosition, YEnd);
